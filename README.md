...
[media-catalog-dynamodb](https://github.com/tatiLogg/media-catalog-dynamodb) A secure, read-only DynamoDB infrastructure deployed with CloudFormation.
...
[python-practice](https://github.com/tatiLogg/python-practice) Building Python fundamentals + hands-on AI infrastructure skills (Kubernetes, vLLM, vector databases) on the path to AI Platform Engineering. Documenting the journey from day one.
